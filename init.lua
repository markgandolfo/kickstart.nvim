...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>st', builtin.tags, { desc = '[S]earch c[T]ags' })
  ...
  { -- LSP Configuration & Plugins
    ...
    dependencies = {
      ...
      { 'williamboman/mason-lspconfig.nvim', commit = '1a31f824b9cd5bc6f342fc29e9a53b60d74af245', config = true },
